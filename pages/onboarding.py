...
with tab3:
    ...
    with st.expander("🗺️ ② 完全オーダーメイドの「特訓カリキュラム（ルート）」"):
        st.markdown("""
        武田塾には、市販の参考書をすべて分析して作られた**「ルート」**と呼ばれるカリキュラムがあります [cite: 44, 114]。
        
        * 一人ひとりの現在の成績や得意・苦手科目を分析し、志望校合格までに**「どの参考書を・どの順番で」**やればいいかをすべて洗い出し、完全オーダーメイドのカリキュラムを作成します [cite: 44, 114]。
    ...
    with st.expander("⏱️ ③ 絶対にサボれない「自学自習の徹底管理」"):
        ...
        * **忘却曲線に基づいたペース:** 人間は忘れる生き物であるという前提に基づき、**「4日進んで2日復習する」** [cite: 44, 113] という最も知識が定着しやすいペースで宿題を組みます。
